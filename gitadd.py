...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "875832e3090dd22b428777f3a07273dcd4461bd4", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "ExxonRsky", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "FTG-modules", lambda m: self.strings("cfg_gh_repo", m))
